...
{
    if (CurrentUser.permissionsRecord == -1) {
        ...
        {
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pShowClients) != 0) {
                ShowAllClientsScreen();
            }
            else {
                cout << "\nYou Cannot Do This Action!!" << endl;
            }
            GoBackToMainMenue();
            break;
        }
        case enMainMenueOptions::eAddNewClient:
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pAddNewClients) != 0) {
                ShowAddNewClientsScreen();
            }
            else {
                cout << "\nYou Cannot Do This Action!!" << endl;
        ...
        case enMainMenueOptions::eDeleteClient:
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pDeleteClients) != 0) {
                ShowDeleteClientScreen();
            }
            else {
                cout << "\nYou Cannot Do This Action!!" << endl;
        ...
        case enMainMenueOptions::eUpdateClient:
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pUpadateClients) != 0) {
                ShowUpdateClientScreen();
            }
            else {
                cout << "\nYou Cannot Do This Action!!" << endl;
        ...
        case enMainMenueOptions::eFindClient:
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pFindClients) != 0) {
                ShowFindClientScreen();
                GoBackToMainMenue();
            }
            else {
        ...
        case enMainMenueOptions::eShowTransactionsMenue:
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pShowTransactions) != 0) {
                ShowTransactionsMenue();
            }
            else {
                cout << "\nYou Cannot Do This Action!!" << endl;
        ...
        case enMainMenueOptions::eManageUsers:
            system("cls");
            if ((CurrentUser.permissionsRecord & enUserPermissions::pManageUsers) != 0) {
                ShowUserManage();
            }
            else {
                cout << "\nYou Cannot Do This Action!!" << endl;
